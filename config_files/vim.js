let VIM_INFO = "tab_info";
let TAB_MODE = "tab_mode";
...
(function() {
  function dialogDiv(cm, template, bottom) {
    ...
    dialog = document.getElementById(VIM_INFO).appendChild(document.createElement("div"));
  ...
  var Vim = function() { return vimApi; } //{
    ...
    function maybeInitVimState(cm) {
      ...
      // INJECTION
      let tabMode = document.getElementById(TAB_MODE);
      tabMode.innerText = "--" + updateTabMode(cm.state.vim) + "--";
      // INJECTION
      return cm.state.vim;
    }
    var vimGlobalState;
    ...
    function makePrompt(prefix, desc) {
      ...
      raw += '<input type="text" style="background: transparent;border: none;outline-width: 0;"/> ' +
          '<span style="color: #f00">';
      if (desc) {
        raw += '<span style="color: #f00">';
        raw += desc;
        raw += '</span>';
      }
      return raw;
